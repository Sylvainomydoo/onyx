...
# $COMPOSE_CMD -f docker-compose.prod-cloud.yml run  --name onyx-stack --rm --entrypoint "\
...
# echo "### Starting nginx ..."
# $COMPOSE_CMD -f docker-compose.prod-cloud.yml -p onyx-stack up --force-recreate -d nginx
# echo
...
# $COMPOSE_CMD -f docker-compose.prod-cloud.yml -p onyx-stack up --force-recreate -d
